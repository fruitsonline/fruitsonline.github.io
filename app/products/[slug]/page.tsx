...
export default function ProductDetail() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8 bg-white text-gray-800">
            ...
            {/* Lower Section: Tabs and Long Description */}
            <div className="border-t border-gray-200">
                <div className="flex flex-wrap gap-8 -mt-px mb-8">
                    {['Description', 'Additional Information', 'Reviews (0)', "What's in the box (4)"].map((tab, idx) => (
                        <button
                            key={tab}
                            className={`py-4 text-xs font-bold uppercase tracking-widest border-t-2 transition-colors ${idx === 0 ? 'border-black text-black' : 'border-transparent text-gray-400 hover:text-black'
                                }`}
                        >
                            {tab}
                        </button>
                ...
                <div className="prose max-w-none text-gray-500 text-sm leading-7">
                    <p className="italic mb-6">
                        I like the things around me to be beautiful and slightly dreamy, with a feeling of worldliness...
                        [Your full text here]
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                        <li>If I fell in love with a woman for an artistic reason.</li>
                        <li>What I hate is nasty, ugly people.</li>
                        <li>People said making clothes inside out was not proper.</li>
                        <li>I disagreed because clothes that are inside out are as beautiful as a cathedral.</li>
                    </ul>
                </div>
            </div>
        </div>
